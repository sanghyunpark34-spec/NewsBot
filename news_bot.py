...
premium_media_domains = ["einfomax.co.kr", "dealsite.co.kr", "investchosun.com", "insjournal.co.kr", "hankyung.com", "sisajournal-e.com", "metroseoul.co.kr", "mtn.co.kr", "kfenews.co.kr"]
...
for keyword in keywords:
    ...
    print(f"키워드 '{keyword}'에서 {len(items)}개 발견")
...
if final_articles:
    ...
    print(f"총 {len(final_articles)}개 전송 성공")
else:
    print("수집된 기사가 없습니다.")
